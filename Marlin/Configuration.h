...
#define CUSTOM_MACHINE_NAME "A10M - 25.03.2020" 
 ...
 */
//#define NOZZLE_TO_PROBE_OFFSET { -40, 0, 0.8 }
...
#define Z_CLEARANCE_BETWEEN_PROBES  5 // 3 // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     5 // 2 // Z Clearance between multiple probes
#define Z_AFTER_PROBING             5 // 3 // Z position after probing is done
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_INVERTING false  // Set to true to invert the logic of the sensors.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT  { X_MIN_POS, Y_MAX_POS , 20 }// { 3, (Y_MAX_POS - 3), 10 }
